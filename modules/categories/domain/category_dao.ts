...
export abstract class CategoryDAO {
  ...
  abstract search( query: Record<string, any>, limit ?: ValidInteger,
    ...
    sortType ?: ValidString ): Promise<Either<BaseException[], PaginatedResult<Category>>>
  abstract add( category: Category ): Promise<Either<BaseException, boolean>>
  abstract update( category: Category ): Promise<Either<BaseException, boolean>>
