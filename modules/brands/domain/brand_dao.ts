...
export abstract class BrandDAO {
  ...
  abstract search( query: Record<string, any>, limit ?: ValidInteger,
    ...
    sortType ?: ValidString ): Promise<Either<BaseException[], PaginatedResult<Brand>>>
  abstract add( brand: Brand ): Promise<Either<BaseException, boolean>>
  abstract update( brand: Brand ): Promise<Either<BaseException, boolean>>
